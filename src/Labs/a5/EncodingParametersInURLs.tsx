...
function EncodingParametersInURLs() {
    ...
    return (
        <div>
            ...
            <a className="btn btn-warning" href={`${API_BASE}/a5/calculator?operation=multiply&a=${a}&b=${b}`}>
                Multiply {a} * {b}
            </a>
            <a className="btn btn-info" href={`${API_BASE}/a5/calculator?operation=divide&a=${a}&b=${b}`}>
                Divide {a} / {b}
            </a>
